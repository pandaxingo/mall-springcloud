...
public class UserController {
    ...
    public ResponseEntity<User> volidCode(@RequestParam("username") String username, @RequestParam("password") String password) {
    ...
    public ResponseEntity<Void> updateUser(@PathVariable("id") Long id, @RequestBody User user) {
        if (user == null || id == null || StringUtils.isBlank(user.getUsername())) {
            return ResponseEntity.badRequest().build();
        }
        user.setId(id);
        this.userService.updateAdminUser(user);
